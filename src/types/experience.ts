...
export const experiences: Experience[] = [
  {
    ...
    endDate: null,
    description:
      "Leading frontend architecture and 6-member team, reducing technical debt by 30% through CI/CD, performance budgets, and monitoring.",
    responsibilities: [
  ...
  },
  {
    ...
    endDate: "Jul 2025",
    description:
      "Developing real-time, high-traffic frontend systems with Next.js and Socket.IO.",
    responsibilities: [
  ...
  },
  {
    ...
    endDate: "Feb 2024",
    description:
      "Developing React applications with focus on performance and user experience.",
    responsibilities: [
